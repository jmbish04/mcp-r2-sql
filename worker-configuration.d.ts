/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4511ddf94cd743c1d119537358ca7f19)
...
interface __BaseEnv_Env {
	...
	R2_SQL_ACCESS_KEY_ID: SecretsStoreSecret;
	R2_SQL_SECRET_ACCESS_KEY: SecretsStoreSecret;
	GOOGLE_MAPS_API: SecretsStoreSecret;
	GOOGLE_SEARCH_API_KEY: SecretsStoreSecret;
	GOOGLE_SEARCH_CSE_ID: SecretsStoreSecret;
	...
	CODE_MODE_AGENT: DurableObjectNamespace<import("./src/worker").CodeModeAgent>;
	BROWSER_HITL_AGENT: DurableObjectNamespace<import("./src/worker").BrowserHitlAgent>;
	WORKFLOWS_AGENT: DurableObjectNamespace<import("./src/worker").WorkflowsAgent>;
	ARTIFACT_AGENT: DurableObjectNamespace<import("./src/worker").ArtifactAgent>;
	CHAT_BROKER: DurableObjectNamespace<import("./src/worker").ChatBroker>;
	NOTIFICATIONS_AGENT: DurableObjectNamespace<import("./src/worker").NotificationsAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "CodeModeAgent" | "BrowserHitlAgent" | "WorkflowsAgent" | "ArtifactAgent" | "ChatBroker" | "NotificationsAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "R2_ACCOUNT_ID" | "R2_BUCKET" | "R2_WAREHOUSE" | "R2_CATALOG_URI" | "R2_NAMESPACE" | "SODA_PERMITS_URL" | "AI_GATEWAY_ID" | "MODEL_CHAT" | "MODEL_EXTRACT" | "MODEL_DRAFT" | "MODEL_TAGGER" | "MODEL_TRANSCRIBE" | "DEFAULT_MODEL_EMBEDDING">> {}
}
